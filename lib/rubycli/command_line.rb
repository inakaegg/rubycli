  ...
  module CommandLine
    USAGE = <<~USAGE
      ...
      Options:
        ...
        --auto-constant      Auto-select the only callable constant when names don't match
        --strict-constant    Require explicit CLASS_OR_MODULE unless names match (default)
